    ...
    public class ParagonUpgrade
    {
        public class Paragon : ModParagonUpgrade<BananaFarmerMod.BananaFarmerTower>
        {
            ...
            public override void ApplyUpgrade(TowerModel towerModel)
            {
                ...
                bananaGunProj.AddBehavior(new DamageModel("DamageModel_", 6, 10, true, true, true, BloonProperties.None,BloonProperties.None, false,false));
                ...
                towerModel.AddBehavior(new MonkeyCityIncomeSupportModel("_MonkeyCityIncomeSupport", "BananaFarmerBuff", 3.1f, null, "MonkeyCityBuff", "BuffIconVillagexx4"));
